  ...
  return (
    <div className=" h-[80vh] md:h-[120vh] flex items-start justify-end px-4 py-8 md:px-16 md:py-16 relative">
      <div className="flex justify-end flex-col w-full">
        ...
        <div
          className="text-[20px] md:text-[28px] lg:text-[40px] text-[#3F3E3D] font-normal leading-[35px] md:leading-[50px] lg:leading-[70px] tracking-[0%] text-justify"
          style={{
      ...
      <div className="absolute left-1/2 bottom-[20px] md:bottom-[0px] -translate-x-1/2 translate-y-0 md:-translate-y-1/2 w-[120px] h-[120px] md:w-[150px] md:h-[150px] lg:w-[184px] lg:h-[184px]">
        <Image
