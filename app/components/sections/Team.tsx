          ...
          return (
            <div
              ...
              style={{
                ...
                maxWidth: isActive ? "240px" : "113px",
                flexBasis: isActive ? "240px" : "0px",
                minWidth: isActive ? "240px" : "80px",
              }}
            >
              <div className="relative w-full lg:h-[350px] 2xl:h-[450px] overflow-hidden">
                <Image
                  src={member.image}
                  alt={member.name}
                  fill
